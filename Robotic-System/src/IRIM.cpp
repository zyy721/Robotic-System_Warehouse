...
std::string SWITHER = "/home/neousys/Desktop/IRIM_EVENTUAL/src/object_detection/tasklists/switch.txt";
...
int main(int argc, char**argv)
{
    ...
    chassic_controller.move_to_position("2");
    the_main_pick_loop("high");
    ptrPickandPlace->move_to_home_UR_no_wait();
    lift_controler.position_low();
    the_main_pick_loop("low");
    
    chassic_controller.move_to_position_while_lift("3","middle");
    the_main_pick_loop("middle");
    ptrPickandPlace->move_to_home_UR_no_wait();
    chassic_controller.move_to_position("4");

    chassic_controller.move_to_position_while_lift("5","low");
    the_main_pick_loop("low");
    lift_controler.position_high();
    the_main_pick_loop("high");
    chassic_controller.move_to_position("6");
    the_main_pick_loop("high");
    ptrPickandPlace->move_to_home_UR_no_wait();
    lift_controler.position_low();
    the_main_pick_loop("low");

    //chassic_controller.move_to_position_while_lift("7","middle");
    //the_main_pick_loop("middle");
    ptrPickandPlace->move_to_home_UR_no_wait();
    chassic_controller.move_to_position("8");
...
{  
    ...
    std::ofstream switcher_c(SWITHER);
    switcher_c << "close" << endl; 
    switcher_c.close();
}
