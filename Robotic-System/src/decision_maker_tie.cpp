...
{   
    ...
    {   
        ...
        static ros::Subscriber sub = ptrNodeHandle->subscribe("/kinect2/qhd/image_color_rect", 5, save_pic_callBack);
        ros::spinOnce();        
        sleep(2);
        ros::spinOnce();
    }
    ...
    std::string DecisionMaker::get_result_tie()
    {
        static ros::Subscriber sub_2D = nh.subscribe("/yolo_class", 1, object_class_capture);
        return object_type;
    }
    ...
    bool DecisionMaker::is_vertical_plan(std::string object_type)
    {
        ...
        !strcmp(object_type.c_str(), "teether")||
        !strcmp(object_type.c_str(), "biscuit")||
        !strcmp(object_tyDeepLearningDMpe.c_str(), "olio")||
        ...
        !strcmp(object_type.c_str(), "juice")||
    ...
    {
        // system("python /home/irim/Desktop/darknet/darknet.py");
